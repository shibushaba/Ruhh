-- Never DELETE cloud transactions during push; upsert only.
-- Prevents a phone with a partial local ledger from wiping SQL/imported history.
...
begin
  ...
  -- transactions: upsert only (no reconcile DELETE)
